...
#ifndef OPENCV1_0_OPENCVFUNCTION_H
#define OPENCV1_0_OPENCVFUNCTION_H

#endif //OPENCV1_0_OPENCVFUNCTION_H
using namespace cv;
...
public:
    ...
    void mousse_drawing_demo(Mat&image);
    ...
    void image_cartoonization_demo(Mat& image);
    void grayscale_is_colored(Mat& image);
    void video_colorization(String videoFileName);
    void image_colorization(String imageFileName);
};